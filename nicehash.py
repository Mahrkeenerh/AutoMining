...
class private_api:
    ...
    def set_mining_rig_status(self, rigId, action, options):
        body = {
            'rigId': rigId,
            'action': action
        }
        ...
        return self.request('POST', '/main/api/v2/mining/rigs/status2', "", body)
    
    def set_mining_rig_status_custom(self, body):
        return self.request('POST', '/main/api/v2/mining/rigs/status2', "", body)

    def get_mining_rigs2(self):
